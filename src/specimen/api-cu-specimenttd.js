...
const base64Initial = open('./initial1.02MB.b64');
...
if (__ITER % 5 === 0 && __ITER !== 0) {
  ...
  const payload = JSON.stringify({
    ...
    data: {
      specimenId: null,
      base64Initial: base64Initial,
    }
  });

  const res = http.post('https://apionprem.mesign.id/api/v1/core/specimen/update', payload, {
    headers,
    timeout: '15s',
  });
